export class CardTemplate {
  static readonly catalog: CardTemplate [] = [
    // Thank You
    {
      url: '/src/assets/images/thank-you-butterflies.png',
      title: 'Thank You #1',
    ...
    {
      url: '/src/assets/images/thank-you-flowers.png',
    ...
    {
      url: '/src/assets/images/thank-you-apple.png',
    ...
    // Happy Birthday
    {
      url: '/src/assets/images/birthday-frog.png',
    ...
    {
      url: '/src/assets/images/birthday-magical.png',
    ...
    {
      url: '/src/assets/images/birthday-island.png',
    ...
    {
      url: '/src/assets/images/birthday-dude.png',
    ...
    // Christmas
    {
      url: '/src/assets/images/christmas-jingle-bells.png',
    ...
    {
      url: '/src/assets/images/christmas-tree.png',
    ...
    {
      url: '/src/assets/images/christmas-angels.png',
    ...
    {
      url: '/src/assets/images/christmas-dolls.png',
    ...
    // Graduation
    {
      url: '/src/assets/images/graduation-owl.png',
    ...
    {
      url: '/src/assets/images/graduation-youdidit.png',
    ...
    {
      url: '/src/assets/images/graduation-leo.png',
    ...
    {
      url: '/src/assets/images/graduation-sammy-spartan.png',
